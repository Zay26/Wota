...
<header class="text-blue-400  text-2xl font-bold text-center py-3"> EDIT USER </header>
<div class="container">
    <form class="max-w-sm" action="{{url('/userEdit/'.$users->id)}}" method="POST" >
      ...
      <div class="form-group">
        <input type="Email" class="form-control form-control-user"
            id="Email" aria-describedby="name" name="email" value="{{old('email') ?? $user->radius}}"
            placeholder="Email">
    </div>
    <div class="md:flex md:items-center mb-6">
      <div class="md:w-1/3">
    ...
    <div class="form-group">
      <input type="password" class="form-control form-control-user"
        ...
        <div class="md:flex md:items-center">
          ...
          <div class="md:w-2/3">
            <button type="button" class="btn btn-success" type="submit">Edit User</button>
